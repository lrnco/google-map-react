...
var GoogleHeatmap = _interopRequireWildcard(_google_heatmap);
  ...
  function GoogleMap(props) {
    ...
    _this._initMap = function () {
      ...
      _this.props.googleMapLoader(bootstrapURLKeys).then(function (maps) {
        ...
        // Start Heatmap
        Object.assign(_this, {
          heatmap: GoogleHeatmap.generateHeatmap(maps, _this.props.heatmap)
        });
        GoogleHeatmap.optionsHeatmap(_this.heatmap, _this.props.heatmap);
        // End Heatmap
